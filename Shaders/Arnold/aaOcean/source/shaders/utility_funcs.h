...
{
   return std::fabs(x - y) <= epsilon * std::fabs(x);  // use this to compare float values
}
...
void rotateArray(fftwf_complex *&fft_array, aaOceanClass *&ocean)
{
...
void copy_and_tile(fftwf_complex *&fft_array, aaOceanClass *&ocean)
{
